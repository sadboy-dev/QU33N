--// QU33N UI v2 FINAL FIXED – Modular Ready
...
task.spawn(function()
	...
	-- =====================================
	-- GLOBAL GUI BRIDGE (MODULAR SYSTEM)
	-- =====================================
	...
	_G.QU33N_GUI = {
		...
		SetTab = function(tabName)
			if pageList[tabName] then
				setActive(tabName)
			end
		end
	}

	_G.SelectTab = _G.QU33N_GUI.SetTab
	_G.OpenPage  = _G.QU33N_GUI.SetTab
